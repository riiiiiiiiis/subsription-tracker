...
const Analytics = () => {
  ...
  const monthlyTrendData = [
    { month: 'Янв', amount: totalMonthly * 0.8 },
    { month: 'Фев', amount: totalMonthly * 0.9 },
    { month: 'Мар', amount: totalMonthly * 0.85 },
    { month: 'Апр', amount: totalMonthly * 1.1 },
    { month: 'Май', amount: totalMonthly * 1.05 },
    { month: 'Июн', amount: totalMonthly },
  ];
  ...
  const getSpendingInsights = () => {
    ...
    if (totalMonthly > 100) {
      insights.push({
        type: 'warning',
        title: 'Высокие ежемесячные расходы',
        description: `Вы тратите ${formatCurrency(totalMonthly)} в месяц. Пересмотрите свои подписки.`,
        icon: TrendingUp,
    ...
    if (upcomingPayments.length > 3) {
      insights.push({
        type: 'info',
        title: 'Множество предстоящих платежей',
        description: `У вас ${upcomingPayments.length} платежей в течение следующих 30 дней.`,
        icon: Calendar,
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Card className="p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <p className="text-sm font-medium text-gray-600">Сумма за месяц</p>
        ...
        <Card className="p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <p className="text-sm font-medium text-gray-600">Средняя цена сервиса</p>
              <p className="text-2xl font-semibold text-gray-900">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card className="p-6">
          <Card.Header>
            <Card.Title>Динамика ежемесячных расходов</Card.Title>
          </Card.Header>
          <Card.Content>
            <div className="h-64">
              <ResponsiveContainer width="100%" height="100%">
      ...
      {insights.length > 0 && (
        <Card className="p-6">
          <Card.Header>
            <Card.Title>Советы по расходам</Card.Title>
          </Card.Header>
          <Card.Content>
            <div className="space-y-4">
